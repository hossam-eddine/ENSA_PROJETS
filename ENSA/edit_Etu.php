...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Etudiants <span>Modifier</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="edit_Etud.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Modifier un étudiant </h4>
              </div>
