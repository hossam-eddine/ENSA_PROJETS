  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="etats_matiere2.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Plans d'étude</h4>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select id="codeM" class="form-control" name="codeM" required>
                      <option value=""></option>
                      <?php
						$sql = "SELECT codeM FROM Matieres GROUP BY codeM ORDER BY codeM";
                  ...
                  <div class="col-sm-6">
                    <select id="natureM" class="form-control" name="natureM" required>
                      <option value=""></option>
