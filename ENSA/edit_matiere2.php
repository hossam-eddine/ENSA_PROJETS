...
$chaine="update matieres set libM='" .$libM. "' ,nature='" .$nature. "', seuil='" .$seuil. "' where codeM = '" . $codeM . "' ";
$result = $conn->prepare($chaine);
$dbexecute=$result->execute();
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="edit_matiere.php" class="form-horizontal" method="post">
...
if ($dbexecute)
	{
	echo " Modificaion effectuée  avec succee. ";
	}
	else
	{
...
?>
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="codeM" class="form-control" placeholder="Saisir le code de matiere" required />
                  </div>
                </div>
