  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="etats_etudiant2.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Etats des etudiants </h4>
              </div>
                    ...
                    <select id="anneeA" class="form-control" name="anneeA" required>
                      ...
                      <?php
						...
						while ($row = $sql_result->fetch(PDO::FETCH_ASSOC)) {
							echo "<option value='".$row["anneeA"]."'".">".$row["anneeA"]."</option>";
							}
						?>
                    </select>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select id="codeG" class="form-control" name="codeG" required>
                      <option value=""></option>
                      <?php
						$sql = "SELECT codeG FROM groupes GROUP BY codeG ORDER BY codeG";
						$sql_result =$conn->query($sql);
						while ($row = $sql_result->fetch(PDO::FETCH_ASSOC)) {
							echo "<option value='".$row["codeG"]."'".">".$row["codeG"]."</option>";
							}
						?>
                    </select>
