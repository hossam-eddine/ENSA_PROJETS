...
$chaine="Delete  from  matieres  where codeM = '" . $codeM . "' ";
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Matières  <span>Suppression</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="sup_matiere2.php" class="form-horizontal" method="post">
...
if ($executed)
	...
	{
	echo " <h4 style='background-color:red;color:white' class='panel-title'>Suppression  Non effectuee </h4>";
	}
	
?></h4>
                <h4 class="panel-title">Supprimer une autre matière</h4>
              </div>
            
                 <div class="form-group">
                  <label class="col-sm-3 control-label">Matiére: </label>
                  <div class="col-sm-6">
                    <select id="codeM" class="form-control" name="codeM" required>
                      <option value=""></option>
                      <?php
						$sql = "SELECT codeM FROM matieres ";
