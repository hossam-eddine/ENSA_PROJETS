...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Groupe <span>Modifier</span></h2>
      <div class="breadcrumb-wrapper">
        <span class="label">Vous êtes dans:</span>
        <ol class="breadcrumb">
          <li><a href="index.html">GET</a></li>
          <li class="active"><a rhef="deconnect.php">se deconnecter</a></li>
        </ol>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="edit_groupes.php" class="form-horizontal" method="post">
