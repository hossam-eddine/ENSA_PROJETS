  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="etats_locaux2.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Liste des locaux : </h4>
              </div>
              <div class="panel-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Départements : </label>
                  <div class="col-sm-6">
                    <select id="codeD" class="form-control" name="codeD" >
                      <option value=""></option>
                      <?php
						$sql = "SELECT codeD FROM deps GROUP BY codeD ORDER BY codeD";
