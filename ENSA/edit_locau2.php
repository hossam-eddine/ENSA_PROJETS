...
$chaine="update locaux set codeL='" .$codeL. " ' ,libL =' " .$libL. "', codeD = '" .$codeD. "'  where codeL = '" . $codeL . "' ";
  ...
  <div class="leftpanel">
    ...
    <div class="pageheader">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="edit_locau.php" class="form-horizontal" method="post">
...
if ($exec)
	{
	echo "Insertion effectuée  avec succee. ";
	}
	else
	{
...
?>
                <h4 class="panel-title"> Voulez vous modifier d'autre locau </h4>
              </div>
		
               <div class="panel-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">code Locau <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="codeL" class="form-control" placeholder="Saisir le code de locau" required />
                  </div>
                </div>
