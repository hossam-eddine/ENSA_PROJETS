...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Etudiants  <span>Nouveau</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <form id="basicForm" action="connection_etud.php" method="post" class="form-horizontal">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Ajouter un nouveau etudiant </h4>
              </div>
              <div class="row">
              <div class="panel-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="cinE" class="form-control" placeholder="Saisir votre N° CIN" required />
                  </div>
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-9">
                  <input type="text" name="nomE" class="form-control" placeholder="Saisir votre nom" required />
                  </div>
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="prenomE" class="form-control" placeholder="Saisir votre prenom" required />
                  </div>
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-9">
                    <input type="date" name="date_naiss" class="form-control" placeholder="Saisir la date de naissance" required />
       ...
       <div class="row">
				...
				<div class="form-group col-md-6">
                  <label class="col-sm-3 control-label">Lieu de naissance <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="lieu_naiss" class="form-control" placeholder="Saisir votre lieu de naiss..." required />
                  </div>
                </div>
               ...
               <div class="row">
                 ...
                 <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-9 row">
                    <div class="rdio rdio-primary col-sm-5">
                ...
                <div class="form-group col-md-6">
                  <label class="col-sm-3 control-label">  groupe <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="codeG" class="form-control" placeholder="Saisir le département..." required />
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  <label class="col-sm-3 control-label">Niveau <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <select name="annee" required>
                      <option  value="1er annee">1er annee</option>
                      <option value="2em annee">2em annee</option>
                      <option value="3em annee">3em annee</option>
                      <option value="4em annee">4em annee</option>
                      <option value="5em annee">5em annee</option>

                    </select>
                  </div>
                </div>
                <div class="form-group col-md-6">
                  <label class="col-sm-3 control-label">anneeA <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="anneeA" class="form-control" placeholder="annee..." required />
