  ...
  <div class="pageheader">
    <h2><i class="fa fa-home"></i> Locaux  <span>Nouveau</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="connection_locaux.php" method="post" class="form-horizontal">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Ajouter une nouveau local </h4>
              </div>
              <div class="panel-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Code <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="codeL" class="form-control" placeholder="SI01" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input type="text" name="libL" class="form-control" placeholder="Salle Informatique 01" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Code de Département <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="codeD" class="form-control" placeholder="TI" required />
                  </div>
                </div>
