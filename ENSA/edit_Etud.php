...
//requette de s�lection
$chaine="SELECT * FROM etudiants where cinE = '" . $cin . "'";

$row=$conn->query($chaine);
if($row->rowCount()>0){
?>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Etudiants <span>Edition</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="edit_Etud1.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Modifier l'etudiant </h4>
              </div>
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="cinE"  readonly="true" class="form-control" value=<?php echo $row[0];?> required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="nomE"   class="form-control" value=<?php echo $row[1];?> required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="prenomE"   class="form-control" value=<?php echo $row[2];?> required />
                  </div>
                </div>
                 <label class="col-sm-3 control-label">Date de Naissance <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                <div class="input-group">
				<input type="date"  name="date_naiss"    class="form-control hasDatepicker" placeholder="dd/mm/yyyy" id="datepicker">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="lieu_naiss"   class="form-control"  value=<?php echo $row[4];?>  required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="email" name="email" class="form-control" text="Saisir  email..." value=<?php echo $row[5];?> required />
                  </div>
                </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="codeG"   class="form-control" value=<?php echo $row[7];?> required />
                  </div>
                </div>
              <?php } ?>
...
<script src="js/dashboard.js"></script>
        ...
        <?php } 
          ...
          echo " <script>alert('etudiant introuvale veuiller verifier cin');
