...
$chaine="SELECT * FROM enseignants where cin = '" . $cin . "'";
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Enseignants  <span>Edition</span></h2>
      <div class="breadcrumb-wrapper">
        <span class="label">Vous �tes dans:</span>
        <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="edit_ens2.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Modifier un enseignant </h4>
              </div>
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="cin"   readonly="true"   class="form-control" value=<?php echo $row[0];?> required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="nom"  disabled="true" class="form-control" value=<?php echo $row[1];?> required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="prenom"  disabled="true" class="form-control" value=<?php echo $row[2];?> required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="email" name="email" class="form-control" value=<?php echo $row[3];?> required />
                  </div>
                </div>
                ...
                <div class="form-group">
                 <label class="col-sm-3 control-label">Spécialité<span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="specialite" name="specialite" disabled="true" class="form-control" value=<?php echo $row[6];?> required />
                  </div>
                </div>
...
<script src="js/dashboard.js"></script>
        ...
        <?php } 
          ...
          echo " <script>alert('ensegnant introuvale veuiller verifier cin');
