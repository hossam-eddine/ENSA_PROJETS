...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Matieres  <span>Nouveau</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="connection_matiere.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Ajouter une nouvelle matiére </h4>
              </div>
              <div class="panel-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Code <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="codeM" class="form-control" placeholder="Saisir le code" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input type="text" name="libM" class="form-control" placeholder="Saisir le libellet" required />
                  </div>
                </div>
				 ...
				 <div class="panel-body">
				  ...
				  <div class="form-group">
                  <label class="col-sm-3 control-label">NatureM</label>
                  <div class="col-sm-9">
                    <select id="NatureM" class="form-control" name="nature" required>
                    ...
                    <label class="error" for="NatureM"></label>
                  </div>
                </div><!-- form-group -->
                 ...
                 <!-- form-group -->
                     ...
                     <div class="form-group">
                  <label class="col-sm-3 control-label">SeuilM</label>
                  <div class="col-sm-9">
                    <select id="SeuilM" class="form-control"name="seuil" required>
                      <option value="">Choisir une</option>
                    ...
                    <label class="error" for="SeuilM"></label>
                  </div>
                </div><!-- form-group -->
