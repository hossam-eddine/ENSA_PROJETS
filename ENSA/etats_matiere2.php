...
//liste des matieres par deps

	$rq="SELECT*  FROM matieres where   codeM='$codeM'";
...
<script type="text/javascript">
  ...
  function imprimer_page(){
  window.print();
  document.location.href = "etats_matiere.php";
}
  </script>
</head>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Matiére  <span>Etats</span></h2>
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Liste des matiéres:</h4>
              </div>
              <div class="panel-body">
<table width="500" border="1" cellspacing="2" cellpadding="4">
  <tr>
    <td width="100" bgcolor="#40ACB5"><strong>code</strong></td>
    <td width="350" bgcolor="#40ACB5"><strong>elements constitutifs</strong></td>
    
    <td width="250" bgcolor="#40ACB5"><strong>nature</strong></td>
    <td width="200" bgcolor="#40ACB5"><strong>seuil</strong></td>
  </tr>
<?php
