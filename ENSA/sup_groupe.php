...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Groupe  <span>Suppression</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="sup_groupe2.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Supprimer un groupe </h4>
              </div>
