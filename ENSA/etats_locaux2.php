...
//liste des locaux 
	...
	$rq="SELECT  *  FROM locaux where  locaux.codeD='$codeD'";
	$result = $conn->query($rq);

	$d="select libD from deps where codeD='$codeD'";
	$dd = $conn->query($d);
	$rowd = $dd->fetch();
...
<head>
  ...
  window.print();
 document.location.href="etats_locaux.php";
}
  </script>
</head>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> locaux  <span>Etats</span></h2>
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">ISET Tozeur</h4>
                <h4 class="panel-title">Liste des locaux <?php if (!empty($_POST["codeD"])){echo " du département ".$rowd[0];}?> </h4>
              </div>
              <div class="panel-body">
<table width="450" border="1" cellspacing="2" cellpadding="4">
  <tr>
    <td width="100" bgcolor="#40ACB5"><strong>codeL</strong></td>
    <td width="350" bgcolor="#40ACB5"><strong>libL</strong></td>
   </tr>
...
?>
<tr><td colspan="2">Pas de resultats.</td>
<?php	
}
?>
