  ...
  if (sem == "") {
    ...
    xmlhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        document.getElementById("groupe").innerHTML = this.responseText;
      }
    };
    xmlhttp.open("GET","etaemploi2.php?gr="+sem,true);
    xmlhttp.send();
  }
}
</script>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      ...
      <div class="row">
        <div class="col-md-6">
        <form id="basicForm" action="etat_emploi3.php" class="form-horizontal" method="post">
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select id="codeL" class="form-control" name="Semestre" onchange="showUser(this.value)" required>
                    <option ></option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select id="codeG" class="form-control" name="codeG" onchange="showUser(this.value)" required>
                    <option ></option>
