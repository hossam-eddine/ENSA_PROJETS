...
$chaine="SELECT * FROM groupes where codeG = '" . $codeG . "'";
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Groupe  <span>Edition</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="edit_groupes2.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Modifier un groupe </h4>
              </div>
			  
             <div class="form-group">
                  <label class="col-sm-3 control-label">Annee <span class="asterisk"></span></label>
                  <div class="col-sm-6">
                    <input type="text" name="anneeA"  readonly="true" class="form-control" value=<?php echo $anneeA;?> required />
                  </div>
                </div>
				
			 
                <div class="form-group">
                  <label class="col-sm-3 control-label">Département <span class="asterisk"></span></label>
                  <div class="col-sm-6">
                    <input type="text" name="codeD"  readonly="true" class="form-control" value=<?php echo $codeD;?> required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="codeG"   class="form-control" value=<?php echo $row[0];?> required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea name="libG"  class="form-control"  ><?php echo $row[1];?></textarea>
