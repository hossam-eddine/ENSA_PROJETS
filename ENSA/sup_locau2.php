...
$chaine="Delete  from  locaux  where codeL = '" . $codeL . "' and codeD='".$_POST["codeD"]."' ";
...
<head>
  <meta charset="utf-8">
  <meta http-equiv="refresh" content="2;url=sup_locau.php">
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Locaux  <span>Suppression</span></h2>
      <div class="breadcrumb-wrapper">
        <span class="label">Vous êtes dans:</span>
        <ol class="breadcrumb">
          <li><a href="index.html">GET</a></li>
          <li class="active">Locaux</li>
        </ol>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="sup_locau2.php" class="form-horizontal" method="post">
...
if ($exec)
	{
	echo "  <h4 style='background-color:#32CD32;color:white' class='panel-title'>Suppression effectuee avec succee</h4>";
	}
	else
	{
	echo "  <h4 style='background-color:red;color:white' class='panel-title'>Suppression effectuee avec succee</h4>";
	}
	
?></h4>
                <h4 class="panel-title">Supprimer un autre local</h4>
              </div>
