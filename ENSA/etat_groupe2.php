...
//anneeA+codeG
	...
	$rq1="SELECT cinE FROM etudiants where anneeA='$anneeA' AND codeG='$codeG' ";
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="panel panel-default">
			  ...
			  <table width="500" height="131" border="3" cellpadding="3" cellspacing="3">
                               <tr>
                                  <td width="50" ><strong>Groupe :<?php echo $codeG ;?> </strong></td>  
								  <td width="50"><strong>Semestre :<?php echo $semestre ;?></strong></td>

                                </tr> 
	                             <td width="50"><strong>Année Universitaire :<?php echo $anneeA ;?></strong></td>
								<td width="50"><strong>Département :<?php echo $codeD ;?></strong></td>
...
<table width="500" border="1" cellspacing="2" cellpadding="4">
  <tr>
    <td width="50"><strong>CIN</strong></td>
    <td width="50"><strong>Nom</strong></td>
    <td width="50"><strong>Prénom</strong></td>
...
<?php
	...
	{
	$rq="SELECT cinE,nomE,prenomE FROM etudiants where cinE='$row1[0]' ";
