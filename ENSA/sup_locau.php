...
function showUser(str) {
  if (str == "") {
    ...
    xmlhttp.open("GET","ajaxdrop.php?q="+str,true);
    xmlhttp.send();
  }
}
</script>
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Supprimer un Local </h4>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select id="codeL" class="form-control" name="codeD" onchange="showUser(this.value)" required>
                    <option ></option>
