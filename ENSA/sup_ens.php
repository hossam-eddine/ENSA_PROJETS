...
$chaine="Delete  from  enseignants  where cin = '" . $cin . "' ";
$prep=$conn->prepare($chaine);
$prep->execute();
$nbr=$prep->rowCount();
if($nbr>0){
...
<head>
  <meta charset="utf-8">
  <meta http-equiv="refresh" content="2;url=supEns.html">
  ...
  <div class="leftpanel">
    ...
    <h5 class="sidebartitle">Navigation</h5>
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li><a href="Annee Universitaire.html"> <span>Année Universitaire</span></a></li>
				<li><a href="dep.php"> <span>Département</span></a></li>

        <li class="nav-parent"><a href="#"><i class="fa fa-edit"></i> <span>Enseignants</span></a>
          <ul class="children">
            <li><a href="ajoutEns.html"><i class="fa fa-caret-right"></i> Nouveau</a></li>
            <li><a href="edit_ens.html"><i class="fa fa-caret-right"></i> Edition</a></li>
			<li><a href="supEns.html"><i class="fa fa-caret-right"></i> Suppression</a></li>
        ...
        <li class="nav-parent"><a href="#"><i class="fa fa-edit"></i> <span>Etudiants</span></a>
          <ul class="children">
            <li><a href="ajoutEtudiant.html"><i class="fa fa-caret-right"></i> Nouveau</a></li>
            <li><a href="edit_Etu.html"><i class="fa fa-caret-right"></i> Edition</a></li>
			<li><a href="supEtud.html"><i class="fa fa-caret-right"></i> Suppression</a></li>
        ...
        <li class="nav-parent"><a href="#"><i class="fa fa-edit"></i> <span>Emplois de temps</span></a>
         <ul class="children">
            <li><a href="general-forms.html"><i class="fa fa-caret-right"></i> Creation</a></li>
...
<li class="nav-parent"><a href="#"><i class="fa fa-edit"></i> <span>Absences</span></a>
        ...
        <li class="nav-parent"><a href="#"><i class="fa fa-edit"></i> <span>Notes</span></a>
         ...
         <ul class="children">
          <li><a href="ajout_groupe.php?dep=TI&annee=2013-2014"><i class="fa fa-caret-right"></i> Nouveau</a></li>
           <li><a href="edit_groupe.php?dep=TI&annee=2013-2014"><i class="fa fa-caret-right"></i> Edition</a></li>
		   <li><a href="sup_groupe.php?dep=TI&annee=2013-2014"><i class="fa fa-caret-right"></i>Suppression</a></li>
            <li><a href="etat_groupes.php?dep=TI&annee=2013-2014"><i class="fa fa-caret-right"></i> Etats</a></li>
          </ul>
        </li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Enseignants  <span>Suppression</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="sup_ens.php" class="form-horizontal" method="post">
		  ...
		  <div class="panel-heading">
                ...
                <h4 style="background-color:#32CD32;color:white" class="panel-title">Suppression effectuee avec succee</h4>
              </div>
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
                ...
                <h4 class="panel-title">Supprimer un enseignant </h4>
              </div>
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" disabled=true name="cin" class="form-control" placeholder="Saisir le N CIN" required />
                  </div>
                </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
		  ...
		  <div class="panel-heading">
                ...
                <h4   style="background-color:red;color:white" class="panel-title">Suppression Non effectuee </h4>
              </div>
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
