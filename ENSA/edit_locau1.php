...
$chaine="SELECT * FROM locaux where codeL = '" . $codeL . "'";
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Locaux  <span>Edition</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form id="basicForm" action="edit_locau2.php" class="form-horizontal" method="post">
          <div class="panel panel-default">
              ...
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Modifier un locau </h4>
              </div>
		    <?php foreach($result as $row){ ?>
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="codeL"  class="form-control" value=<?php echo $row[0];?> required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="libL"   class="form-control" value=<?php echo $row[1];?> required />
                  </div>
                </div>
                
                <div class="panel-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Code Département <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" name="codeD"   class="form-control" value=<?php echo $row[2];?> required />
                  </div>
                </div>
        <?php }?>
