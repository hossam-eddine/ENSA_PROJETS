...
$req=" Insert Into locaux  Values('" .$codeL. "','" .$libL. "','" .$codeD. "' )";
$result = $conn->prepare($req);
$dbexec=$result->execute();
?>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Locaux  <span>Nouveau</span></h2>
      <div class="breadcrumb-wrapper">
        <span class="label">Vous etes  dans:</span>
        <ol class="breadcrumb">
        ...
        <div class="col-md-6">
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Ajouter un nouveau  local </h4>
              </div>
			  <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
...
if ($dbexec)
	{
	echo "Le local  ".$codeL. "  est insere avec succee. ";
	}
	else
	{
...
?>
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="codeL" class="form-control" placeholder="Saisir le code" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input type="text" name="libL" class="form-control" placeholder="Saisir le libellet" required />
                  </div>
                </div>
				
				
                <div class="form-group">
                  <label class="col-sm-3 control-label">Code de Département</label>
                  <div class="col-sm-9">
                    <select id="Code de Departement"  name="codeD" class="form-control" required>
                      <option value="">Choisir une</option>
                      <option value="TI">TI</option>
                      <option value="amphA">amphiA</option>
					   <option value="amphB">AmphiB</option>
                   <option value="IN">IN</option>

				   
                    </select>
                    <label class="error" for="Code de Departement"></label>
                  </div>
                </div><!-- form-group -->
